  ...
  return (
    ...
    >
      ...
      <h2 className="hero-subheadline text-lg sm:text-2xl font-medium text-muted-foreground mb-8 max-w-2xl mx-auto">
        Scribo is your personal space on the web. Capture, organize, and share
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="testimonial-card flex flex-col items-center text-center p-8 bg-muted/60 rounded-xl shadow-sm border border-muted">
            ...
            <p className="text-base text-muted-foreground mb-4">
              “Scribo has completely changed the way I organize my thoughts. The
          ...
          <div className="testimonial-card flex flex-col items-center text-center p-8 bg-muted/60 rounded-xl shadow-sm border border-muted">
            ...
            />
            <p className="text-base text-muted-foreground mb-4">
              “I love how simple and fast it is to capture ideas. Scribo is my
        ...
        <div className="flex justify-center">
          <div className="pricing-card flex flex-col items-center text-center p-10 bg-muted/60 rounded-xl shadow-lg border border-muted max-w-md w-full">
            ...
            <p className="text-muted-foreground text-base mb-4">
              Scribo is completely free to use. No subscriptions. No paywalls.
              Forever.
              <br />
              Built by the community, for the community.
            </p>
            <a
              href="https://github.com/Shr3kx/Scribo"
              target="_blank"
...
export const LandingFAQ = () => {
  ...
  const faqs = [
    ...
    {
      q: "Can I use Scribo on mobile?",
      a: "Absolutely! Scribo is fully responsive and works great on any device.",
    },
    {
